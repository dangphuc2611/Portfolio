...
let findMe = document.getElementById("find-me-container");
...
let mobileFindme = document.getElementById("mobile-find-me-container");
let mobileEducation = document.getElementById("mobile-education-container")

findMe.addEventListener("click", () => {
    document.getElementById("find-me-info").classList.toggle("hidden")
})

mobileFindme.addEventListener("click", () => {
    document.getElementById("mobile-find-me-info").classList.toggle("hidden")
})
...
// Example output: "Sun, 27 Jul"

// If you want "Sun 27 Jul" (without comma):
const simpleDate = formattedDate.replace(',', '');
